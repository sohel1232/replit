...
public class SecurityConfig {
    ...
    @Bean
    public DaoAuthenticationProvider authenticationProvider(UserLoginService userService) {
...
//                                .requestMatchers(HttpMethod.DELETE,"/api/Posts/").hasAnyRole("AUTHOR","ADMIN")
                ...
                .formLogin(form ->
                        form
                                ...
                                .defaultSuccessUrl("/replit/home",true)
                                .permitAll()
                )
                .oauth2Login(oauth2Login ->
                        oauth2Login
                                .loginPage("/customlogin")
                                .permitAll().defaultSuccessUrl("/replit/home",true)
                )
                .logout(logout ->
                        logout
                                .logoutUrl("/logout")
